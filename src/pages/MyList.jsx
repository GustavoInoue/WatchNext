...
export default function MyList() {
  ...
  // Determina o mediaType padrão da grade (usado como fallback quando o título
  // não traz o seu próprio; na prática cada item da lista já tem mediaType salvo).
  let defaultMediaType = null;
  if (items.length > 0) {
    defaultMediaType = items[0].mediaType;
  }
