...
export default function TitleCard({ title, mediaType, isSaved, onToggleSave }) {
  ...
  let saveClass = "title-card__save";
  let saveLabel = "Salvar na minha lista";
  let saveIcon = <Bookmark size={18} />;

  if (isSaved) {
    saveLabel = "Remover da minha lista";
    saveIcon = <BookmarkCheck size={18} />;
  }
